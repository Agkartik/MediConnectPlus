...
const features = [
  {
    ...
    desc: "Chat & video with verified doctors instantly",
  },
  {
    icon: MapPin,
    title: "Clinic Discovery",
    desc: "Find nearby clinics & doctors on a map",
  },
  {
    icon: Pill,
    title: "Digital Pharmacy",
    desc: "Order prescribed medicines with delivery",
  },
  {
    icon: Activity,
    title: "Wearable Monitoring",
    desc: "Real-time health data with smart alerts",
  },
  {
    icon: Globe,
    title: "Multilingual",
    desc: "Healthcare in your preferred language",
  },
  {
    icon: Shield,
    title: "Secure & Compliant",
    desc: "Role-based access with encrypted data",
  },
];
...
const roles = [
  {
    ...
    icon: Heart,
    title: "Patient",
    desc: "Access healthcare, book consultations, track health",
  ...
  },
  {
    ...
    icon: Stethoscope,
    title: "Doctor",
    desc: "Manage patients, consultations & earnings",
...
const howItWorks = [
  {
    ...
    desc: "Sign up as a patient or doctor in under a minute. Verify your email to get started.",
  },
  {
    step: 2,
    icon: SearchIcon,
    title: "Find & Connect",
    desc: "Patients search for top-rated doctors by specialty. Doctors get discovered by patients instantly.",
  },
  {
    step: 3,
    icon: CalendarCheck,
    title: "Book & Consult",
    desc: "Schedule video, chat, or in-person appointments. Join consultations with one click.",
  },
  {
    step: 4,
    icon: CheckCircle,
    title: "Track & Manage",
    desc: "Monitor health data in real-time, manage prescriptions, and order medicines with delivery.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      <header className="relative overflow-hidden">
        ...
        <nav className="relative z-10 container mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="ghost"
              size="icon"
              className="text-muted-foreground/10 hover:text-muted-foreground/30"
        ...
        <div className="relative z-10 container mx-auto px-6 py-20 lg:py-32">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-xl mb-8">
              Consultations, clinic discovery, pharmacy, wearable monitoring —
              all unified in one intelligent platform for preventive,
              data-driven healthcare.
            </p>
            <div className="flex flex-wrap gap-4">
              <Button
                size="lg"
                className="gradient-primary text-primary-foreground px-8 shadow-soft"
        ...
        <motion.div
          ...
          className="absolute top-32 right-20 w-16 h-16 rounded-2xl gradient-primary opacity-20 hidden lg:block"
        />
        <motion.div
          animate={{ y: [0, 10, 0] }}
          transition={{ duration: 4, repeat: Infinity }}
          className="absolute bottom-20 right-40 w-24 h-24 rounded-full bg-accent/10 hidden lg:block"
        />
      </header>
      ...
      <section
        id="how-it-works"
        className="container mx-auto px-6 py-20 border-b border-border/30"
      >
        <motion.div
        ...
        >
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Get started in 4 simple steps — from signup to complete healthcare
            management.
          </p>
        </motion.div>
      ...
      <section id="features" className="container mx-auto px-6 py-20">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Everything you need for complete healthcare, seamlessly integrated.
          </p>
        </motion.div>
      ...
      <section className="container mx-auto px-6 py-20">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Specialized dashboards for patients and doctors.
          </p>
        </motion.div>
        <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          {roles.map((r, i) => (
            ...
            >
              <div
                className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${r.color} flex items-center justify-center mx-auto mb-5 group-hover:scale-110 transition-transform`}
              >
      ...
      <footer className="border-t border-border py-8">
        <div className="container mx-auto px-6 flex items-center justify-between text-sm text-muted-foreground">
          <span className="flex items-center gap-2">
            <AppLogoMark title="" className="w-4 h-4" /> MediConnect+ © 2026
          </span>
